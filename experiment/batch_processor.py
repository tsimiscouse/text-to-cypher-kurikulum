"""
Batch Processor for the Agentic Text2Cypher pipeline.

Handles batch processing of questions with progress tracking and resumability.
"""
import os
import json
import logging
...
class BatchProcessor:
    ...
    def process_batch(
        ...
        logger.info(
            f"Starting batch {batch_id} for {config_name}: "
        ...
        for i, item in enumerate(items_to_process):
            try:
                ...
                # Callback
                if on_item_complete:
                    on_item_complete(item.id, final_state)
